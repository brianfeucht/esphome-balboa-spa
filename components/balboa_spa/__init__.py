...
Jet1Fan = balboa_spa_ns.class_('Jet1Fan', cg.Component)
Jet2Fan = balboa_spa_ns.class_('Jet2Fan', cg.Component)
Jet3Fan = balboa_spa_ns.class_('Jet3Fan', cg.Component)
Jet4Fan = balboa_spa_ns.class_('Jet4Fan', cg.Component)
